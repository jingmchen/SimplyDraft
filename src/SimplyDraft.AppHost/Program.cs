...
internal sealed class Program
{
    ...
    internal static int Main(string[] args)
    {
        ...
        try
        {
            ...
            using IHost host = BuildHost(args, appInfo, appPaths, appSettings);
    ...
    private static IHost BuildHost(string[] args, AppInfo appInfo, AppPaths appPaths, AppSettingsProvider appSettings)
    {
