...
internal static class DocxWriterConstants
{
    ...
    /// <summary>
    /// File extensions as they appear in <c>[Content_Types].xml</c>
    /// Separate purpose from <c>InfrastructureConstants.FileExtensions</c>
    /// </summary>
    internal static class FileExtensions
    {
        public const string Relationships = "rels";
