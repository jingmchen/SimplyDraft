...
public static class DocxWriter
{
    ...
    )
    {
        ...
        if (media.Any(item => item.ContentType == DocxWriterConstants.ContentTypes.Png))
            AppendDefaultContentType(builder, DocxWriterConstants.FileExtensions.Png, DocxWriterConstants.ContentTypes.Png);
        
        if (media.Any(item => item.ContentType == DocxWriterConstants.ContentTypes.Jpeg))
            AppendDefaultContentType(builder, DocxWriterConstants.FileExtensions.Jpg, DocxWriterConstants.ContentTypes.Jpeg);
