...
public sealed class Parser
{
    ...
    public static Expression ParseExpressionOnly(string source, int startLine = 1, int startColumn = 1)
    {
        var parser = new Parser(Lexer.LexExpression(source, startLine, startColumn));
